  ...
  <main>
    ...
    <section class="mordal">
        <div class="wrapper">
          <div class="inner">
              <div class="img-pc">
                <img src="<?php echo esc_url( wp_get_attachment_image_url( (int) get_field('img_pc'), 'full' ) ); ?>" alt="ENERGYGYM">
              </div>
              <div class="img-sp">
                <img src="<?php echo esc_url( wp_get_attachment_image_url( (int) get_field('img_sp'), 'full' ) ); ?>" alt="ENERGYGYM">
              </div>
          </div>
          <div class="works-detail-content-btn">
            <a class="btn" href="<?php echo esc_url(home_url('/')); ?>works">Back to Works</a>
          </div>
        </div>
    </section>
